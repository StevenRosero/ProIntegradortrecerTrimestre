...
public class GuiPrincipal extends JFrame implements InterfazGui {
	...
	public void inicializar() {
		...
		layeredPane.setBounds(0, 43, 1284, 762);
		getContentPane().add(layeredPane);
		panelPrincipal = new GuiPanelPrincipal();
		panelPrincipal.setBounds(0, -80, 1280, 784);
	...
	public void setControlador(ControladorIntegraApp control) {
		panelPrincipal.getBtnLogin().addActionListener(control);
	}
	
	public JButton getBtnLogin() {
		return panelPrincipal.getBtnLogin();
	}
	...
	public void esUsuarioAdministrador() {
		...
		panelPrincipal.getLblIdentificacion().setText(txtAdmin);
	}
